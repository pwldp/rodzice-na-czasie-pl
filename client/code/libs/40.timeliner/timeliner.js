...
;(function($) {
	...
	settings = jQuery.extend({
		...
		baseSpeed: 120 // value: any integer, default to 200; determines the base speed, some animations are a multiple (4x) of the base speed
	}, options);
